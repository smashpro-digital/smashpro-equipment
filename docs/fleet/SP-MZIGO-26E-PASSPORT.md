...
| Nickname | Mzigo |
| Meaning | *Mzigo* (Swahili) = "load", "cargo", or "freight" |
...
The brand illustration remains the Passport hero; the September 9 three-quarter
photograph remains the walkaround poster. August 31 assembly photographs and video
...
| Item | Specification |
|------|---------------|
| Battery | 48V 20Ah × 2 (lead-acid) |
| Motor | Dual brushless motors |
| Motor output | 2 × 500 W |
| Drive | 4-wheel drive, electric |
...
| Item | Value |
|------|-------|
| Overall Length | 1,170 mm (46.06 in) |
| Overall Width | 820 mm (32.28 in) |
| Overall Height | 870 mm (34.25 in) |
| Cargo Bed | 1,170 × 780 × 300 mm (46.06 × 30.71 × 11.81 in) |
