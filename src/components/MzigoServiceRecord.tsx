...
export function MzigoServiceRecord({ item }: { item: Equipment }) {
  return <section className="section shell ardhi-service-record mzigo-service-record" id="service" aria-labelledby="mzigo-service-title">
    ...
    <p className="mzigo-readiness">Factory approval does not establish readiness for service. Payment, export, arrival checks, commissioning, operating guidance and site eligibility must be completed or verified before operation. Rental availability has not been announced.</p>
  </section>;
}
