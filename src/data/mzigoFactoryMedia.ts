...
export const mzigoFactoryPhotos = {
  ...
  complete: photo("sp-mzigo-26e-factory-complete-three-quarter-2026-09-09.jpg", "September 9 SP-MZIGO-26E factory view in SmashPro green showing the dump body, four-wheel stance and fleet graphics", "September 9 completed-body view preserved before the later black wheel, battery-box and tie-down revisions.", "exterior", 1536, 864),
  ...
  raisedDriveOverview: photo("sp-mzigo-26e-raised-bed-drive-system-overview-2026-09-14.jpg", "SP-MZIGO-26E raised-bed side overview showing the lift cylinder, black chassis, drive motors, controllers and service access", "Additional post-revision overview of the hydraulic lift and electric drive packaging beneath the raised body.", "hydraulics", 1280, 960, "2026-09-14", archiveChannels),
