...
export const equipment: Equipment[] = [
  {
    ...
    capabilityStatement: "Compact earthmoving, lifting, landscaping, material handling, and attachment-powered work.", heroImage: image("equipment/sp-ardhi-26/hero/sp-ardhi-26-hero.png"), status: "shipping", statusLabel: "Shipping Phase",
    ...
    media: [
      { id: "ardhi-pallet-fork-test", title: "Pallet fork testing", kind: "video", url: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-pallet-fork-test.mp4"), description: "Production testing with the pallet fork attachment." },
      { id: "ardhi-test", title: "Factory testing", kind: "video", url: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-factory-test.mp4") },
      { id: "ardhi-build", title: "Factory build", kind: "video", url: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-factory-build-walkaround.mp4") },
    ...
    gallery: [
      ...
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-completed-build-attachments.jpg"), alt: "SP-ARDHI-26 completed factory build with bucket and branded pallet forks", caption: "SP-ARDHI-26 completed factory build with bucket and branded pallet forks" },
      { id: "ardhi-finish-profile", src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-left-side-profile.jpg"), alt: "SP-ARDHI-26 factory body panels finished in high-gloss RAL 6018 green", caption: "SP-ARDHI-26 left-side profile in RAL 6018 green and black" },
      { id: "ardhi-branding-detail", src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-control-panel.jpg"), alt: "Factory-applied SmashPro branding and controls on the completed SP-ARDHI-26", caption: "SP-ARDHI-26 control panel with factory-applied SmashPro branding" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-right-side-profile.jpg"), alt: "SP-ARDHI-26 right-side profile showing tracks and loader arms", caption: "SP-ARDHI-26 right-side profile showing tracks and loader arms" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-rear-branding-and-controls.jpg"), alt: "Rear view of SP-ARDHI-26 showing its control station, tracks, protective grille, and SmashPro branding", caption: "SP-ARDHI-26 rear branding and control station" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-factory-side-profile.png"), alt: "SP-ARDHI-26 factory side profile", caption: "Factory side profile" },
      { id: "ardhi-front-work-lights", src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-front-work-lights.png"), alt: "Factory-installed front LED work lights illuminated on SP-ARDHI-26", caption: "Front branding and illuminated work lights" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-bucket-branding.png"), alt: "SP-ARDHI-26 bucket branding", caption: "Bucket branding" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-power-outlet-detail.jpg"), alt: "Close view of the labeled 12-volt 120-watt power outlet on SP-ARDHI-26", caption: "12-volt 120-watt power outlet detail" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-factory-assembly-floor.jpg"), alt: "SP-ARDHI-26 on the factory assembly floor with technicians working on nearby compact loaders", caption: "Factory assembly floor" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-powertrain-installation.jpg"), alt: "SP-ARDHI-26 powertrain installation", caption: "Powertrain installation" },
      { id: "ardhi-hydraulic-system-progress", src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-hydraulic-system-installation.jpg"), alt: "Open SP-ARDHI-26 engine compartment showing the factory-installed hydraulic system", caption: "Hydraulic system" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-pallet-fork-test.mp4?v=h264-20260807"), alt: "SP-ARDHI-26 testing the pallet fork attachment", caption: "Pallet fork testing", kind: "video" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-factory-test.mp4"), alt: "SP-ARDHI-26 factory testing video", caption: "Factory testing", kind: "video" },
      { src: image("equipment/sp-ardhi-26/factory/sp-ardhi-26-factory-build-walkaround.mp4"), alt: "SP-ARDHI-26 factory build video", caption: "Factory build", kind: "video" },
  ...
  },
  {
    ...
    capabilityStatement: "Electric material transport with zero tailpipe emissions, quiet operation, and remote-controlled precision.", heroImage: image("equipment/sp-mzigo-26e/hero/sp-mzigo-26e-hero.png"), status: "fleet-build", statusLabel: "Electric fleet build — availability not announced",
