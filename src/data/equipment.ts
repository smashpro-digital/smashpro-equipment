...
export const equipment: Equipment[] = [
  {
    ...
    statusDetail: "SP-ARDHI-26 has been loaded into its export shipping container for ocean freight aboard EVER MAX, voyage 1374-016E.",
    ...
    logisticsGraphics: [
      {
        id: "ardhi-logistics-facility",
        title: "Infront factory facility context",
        eyebrow: "Factory origin",
        description: "Original facility-style graphic representing the manufacturing handoff without publishing site-specific street details, staging lanes, or storage waypoints.",
        src: image("sp-ardhi-26-logistics-infront-factory-facility.png"),
        alt: "Editorial industrial factory facility graphic representing SP-ARDHI-26 export preparation without visible signage or address details",
        caption: "Approximate manufacturing-facility context for the export lifecycle record.",
        width: 1680,
        height: 960,
        sourceNote: "Generated privacy-safe visual based on public manufacturer identity.",
      },
      {
        id: "ardhi-logistics-vessel",
        title: "Current vessel visual",
        eyebrow: "Ocean carrier",
        description: "Original vessel graphic representing EVER MAX, voyage 1374-016E, without copying carrier marks or exposing container identifiers.",
        src: image("sp-ardhi-26-logistics-ever-max-vessel.png"),
        alt: "Large container vessel graphic representing EVER MAX during SP-ARDHI-26 export shipping",
        caption: "Current vessel context for the container-loaded milestone.",
        width: 1680,
        height: 960,
        sourceNote: "Public vessel trackers identify EVER MAX as a container ship; this is an original representational graphic.",
      },
      {
        id: "ardhi-logistics-geography",
        title: "Tracking geography update",
        eyebrow: "Approximate route",
        description: "Decorative route geography showing the public international movement from factory handoff through ocean freight, U.S. port processing, South Carolina, and SmashPro HQ.",
        src: image("sp-ardhi-26-logistics-route-geography.png"),
        alt: "Decorative map graphic showing approximate SP-ARDHI-26 logistics movement from East Asia across the Pacific toward the United States and South Carolina",
        caption: "Approximate route only; no GPS-accurate production, storage, port-processing, or private destination details are published.",
        width: 1680,
        height: 960,
        sourceNote: "Approximate geography graphic, not a live AIS map or GPS record.",
      },
    ],
    factoryOptions: [
    ...
    timeline: [
      ...
      { id: "ardhi-final-payment-completed", occurredAt: "2026-09-02", kind: "purchase", milestone: "final-payment", title: "Final Payment Completed", detail: "Final balance received. Machine officially entered export logistics.", publicDisplay: true, photos: [], videos: [] },
      ...
      { id: "ardhi-export-crate-scheduled", occurredAt: "2026-09-02", kind: "status", milestone: "export-crate", title: "Export Crate Documented", detail: "The sealed wooden export crate and its freight tracking label were documented before container loading.", publicDisplay: true, photos: [], videos: [image("sp-ardhi-26-export-crate-documentation-2026-09-02.mp4")] },
    ...
    media: [
      ...
      { id: "ardhi-export-crate-video-20260902", title: "Export crate documented", kind: "video", role: "build", url: image("sp-ardhi-26-export-crate-documentation-2026-09-02.mp4"), publishedAt: "2026-09-02", description: "A factory-side record of the sealed wooden export crate and its freight tracking label before container loading." },
    ...
    gallery: [
      { id: "ardhi-logistics-facility-gallery", src: image("sp-ardhi-26-logistics-infront-factory-facility.png"), alt: "Editorial industrial factory facility graphic representing SP-ARDHI-26 export preparation without visible signage or address details", caption: "Privacy-safe facility context graphic for the factory-to-export handoff.", capturedAt: "2026-09-02", width: 1680, height: 960, group: "export" },
      { id: "ardhi-logistics-vessel-gallery", src: image("sp-ardhi-26-logistics-ever-max-vessel.png"), alt: "Large container vessel graphic representing EVER MAX during SP-ARDHI-26 export shipping", caption: "Current vessel context graphic for EVER MAX voyage 1374-016E.", capturedAt: "2026-09-02", width: 1680, height: 960, group: "shipping" },
      { id: "ardhi-logistics-geography-gallery", src: image("sp-ardhi-26-logistics-route-geography.png"), alt: "Decorative map graphic showing approximate SP-ARDHI-26 logistics movement from East Asia across the Pacific toward the United States and South Carolina", caption: "Approximate tracking geography graphic with private and exact logistics locations withheld.", capturedAt: "2026-09-02", width: 1680, height: 960, group: "shipping" },
      ...
      { id: "ardhi-export-crate-video-20260902", src: image("sp-ardhi-26-export-crate-documentation-2026-09-02.mp4"), alt: "Video documenting the sealed wooden export crate and freight tracking label for SP-ARDHI-26", caption: "Export crate and freight tracking label documented before container loading.", kind: "video", capturedAt: "2026-09-02", width: 540, height: 960, group: "export" },
      ...
      { src: image("sp-ardhi-26-pallet-fork-test.mp4?v=h264-20260807"), alt: "SP-ARDHI-26 testing the pallet fork attachment", caption: "Pallet fork testing", kind: "video", group: "completed-machine" },
      { src: image("sp-ardhi-26-factory-test.mp4"), alt: "SP-ARDHI-26 factory testing video", caption: "Factory testing", kind: "video", group: "factory" },
