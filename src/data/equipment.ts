...
export const equipment: Equipment[] = [
  {
    ...
    timeline: [
      ...
      { id: "ardhi-export-container-loaded", occurredAt: "2026-09-02", kind: "status", milestone: "container-loaded", title: "Consolidated Container Loading Reported", detail: "The supplier-provided freight-forwarder record reports consolidated-container loading at 09:42:48 local record time. ISO container and bill-of-lading identifiers remain pending.", publicDisplay: true, photos: [], videos: [] },
      { id: "ardhi-export-customs-released", occurredAt: "2026-09-02", kind: "status", milestone: "customs-released", title: "Chinese Export Customs Released", detail: "The supplier-provided freight-forwarder record reports domestic export-customs release at 18:07:41 local record time.", publicDisplay: true, photos: [], videos: [] },
      { id: "ardhi-ocean-departure-reported", occurredAt: "2026-09-07", kind: "status", milestone: "ocean-transit", title: "Ocean Departure Reported", detail: "The freight-forwarder tracking record reports departure aboard EVER MAX voyage 1374-016E and an estimated port arrival of October 5, 2026 local time. Independent carrier/BOL confirmation remains pending.", publicDisplay: true, photos: [], videos: [] },
  ...
  },
  {
    ...
    factoryOptions: [
      { id: "mzigo-black-wheels", name: "Black wheel finish", description: "Black wheel finish installed on the Founders Edition.", publicDisplay: true, installationSource: "factory", evidenceMediaId: "sp-mzigo-26e-black-wheel-drive-motor-2026-09-14" },
      { id: "mzigo-black-battery-boxes", name: "Black battery boxes", description: "Two black service-access battery enclosures installed beneath the dump body.", publicDisplay: true, installationSource: "factory", evidenceMediaId: "sp-mzigo-26e-black-battery-boxes-hydraulic-power-unit-2026-09-14" },
      { id: "mzigo-brand-identity", name: "SmashPro branding and fleet decals", description: "Custom SmashPro identity graphics installed on the green cargo body and controls.", publicDisplay: true, installationSource: "factory", evidenceMediaId: "sp-mzigo-26e-build-approved-left-profile-2026-09-15" },
      { id: "mzigo-qr-identity", name: "Equipment Passport QR panel", description: "QR identity panel retained on the completed machine.", publicDisplay: true, installationSource: "factory", evidenceMediaId: "sp-mzigo-26e-build-approved-left-profile-2026-09-15" },
      { id: "mzigo-tie-down-anchors", name: "Tie-down anchors", description: "Added securement hardware documented in the post-revision factory evidence.", publicDisplay: true, installationSource: "factory", evidenceMediaId: "sp-mzigo-26e-tie-down-anchor-detail-2026-09-14" },
    ], upgrades: [
      ...
      { id: "mzigo-qr", name: "Equipment QR Identification", category: "Identity", description: "Factory-installed QR identity panel linked to the permanent equipment record.", imageUrls: [image("sp-mzigo-26e-build-approved-left-profile-2026-09-15.jpg")], status: "installed", installedBy: "Shandong Kylin Heavy Industry Machinery Co., Ltd.", tags: ["qr identification"] },
