...
export const equipment: Equipment[] = [
  {
    ...
    timeline: [
      ...
      { id: "ardhi-export-crate-scheduled", occurredAt: "2026-09-02", kind: "status", milestone: "export-crate", title: "Export Crate Scheduled", detail: "Machine palletized and prepared for wooden export crate.", publicDisplay: true, photos: [], videos: [] },
