...
export const equipment: Equipment[] = [
  {
    ...
    statusDetail: "Export logistics record. Current shipment stage and ocean departure require confirmation from Digital HQ.",
    ...
    timeline: [
      ...
      { id: "ardhi-export-container-loaded", occurredAt: "2026-09-02", kind: "status", milestone: "container-loaded", title: "Export Container Loaded", detail: "Archived export reference. Container loading and ocean departure await evidence confirmation in the Digital HQ shipment record.", publicDisplay: true, photos: [], videos: [] },
