import { CommissioningPassport } from "../components/CommissioningPassport";
...
export function EquipmentPassportPage({ slug }: { slug: string }) {
  ...
  return <PageFrame><SeoSchema item={item} />
    ...
    {item.commissioning ? <CommissioningPassport item={item} /> : item.slug === "sp-ardhi-26" ? <ArdhiPassportJourney item={item} /> : <MzigoPassport item={item} />}
